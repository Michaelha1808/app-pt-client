...
<template>
  ...
  <Transition name="float-in">
    <button
      v-if="isIn && !isOpen"
      class="fixed z-40 ios-press"
      style="bottom: 100px; right: 285px"
      @click="openPanel"
    >
      <!-- Glow ring -->
      <div
        class="absolute inset-0 rounded-full bg-calor-green animate-glow-pulse"
        style="margin: -8px"
      />
      <!-- Character -->
      <div class="relative char-idle">
        <img
