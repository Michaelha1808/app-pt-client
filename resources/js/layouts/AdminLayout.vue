...
const nav = [
  ...
  { to: '/admin/dishes',     label: 'Thư viện món', icon: 'M3 3h18v4H3V3zm0 7h18v4H3v-4zm0 7h18v4H3v-4z' },
  { to: '/admin/dataset',    label: 'Dataset AI',   icon: 'M4 7v10c0 1.1 3.6 2 8 2s8-.9 8-2V7M4 7c0 1.1 3.6 2 8 2s8-.9 8-2M4 7c0-1.1 3.6-2 8-2s8 .9 8 2' },
