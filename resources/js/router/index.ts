...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/chat/history', component: () => import('@/pages/ChatHistory.vue'), meta: { layout: 'app', middleware: 'auth-strict' } },
  { path: '/chat/history/:id', component: () => import('@/pages/ChatHistoryDetail.vue'), meta: { layout: 'app', middleware: 'auth-strict' } },
  ...
  { path: '/plan/progress', component: () => import('@/pages/PlanProgress.vue'), meta: { layout: 'app', middleware: 'auth-strict' } },
  { path: '/profile', component: () => import('@/pages/Profile.vue'), meta: { layout: 'app', middleware: 'auth-strict' } },
  ...
  { path: '/admin/chat-logs', component: () => import('@/pages/admin/ChatLogs.vue'), meta: { layout: 'admin', middleware: 'admin' } },
