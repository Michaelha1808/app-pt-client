...
Schedule::command(SendMorningNotifications::class)->everyMinute()->withoutOverlapping();
...
Schedule::command(SendEveningNotifications::class)->everyMinute()->withoutOverlapping();
...
Schedule::command(SendStreakRiskReminders::class)->everyMinute()->withoutOverlapping();
